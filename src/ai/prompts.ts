...
export const SYSTEM_PROMPTS: Record<string, string> = {
  en: [
    ...
    `- Prioritize high-priority items (priority 4 is highest, 1 is lowest). Always mention high-priority tasks but never reference priority numbers — just say "important" or "key".`,
  ...
  pl: [
    ...
    `- Skup się na zadaniach o wysokim priorytecie (priorytet 4 jest najwyższy, 1 najniższy). Zawsze wspomnij o ważnych zadaniach, ale nigdy nie podawaj numerów priorytetów — mów "ważne" lub "kluczowe".`,
